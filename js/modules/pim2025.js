...
//             // Marcadores invisibles para permitir la interacción sobre el WMS
...
//         // Sincronización de capas WFS (datos) y WMS (visualización)
...
//     // --- ADECUACIÓN: EXTRACCIÓN DE COORDENADAS ---
//     // Usamos los nombres de campos que ya te funcionaron en FAISMUN (inicial / final)
...
//     // Formateo de la lista de descripción
...
//                 <div style="font-size: 10px; color: #888; font-weight: bold; text-transform: uppercase;">DESCRIPCIÓN DEL PROYECTO</div>
//                 <div style="background: #E0F2F1; border-left: 4px solid #00897B; padding: 8px; font-size: 12px; margin-bottom: 15px; line-height: 1.4;">
//                     ${descList}
//                 </div>
...
//                 <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 15px; padding: 8px; background-color: #f4f8f8; border-radius: 4px; border: 1px solid #e0e0e0; font-size: 10px;">
//                     <div>
//                         <strong style="color: #00796B;"><i class="fa-solid fa-play text-success"></i> Inicial:</strong><br>
//                         <span style="font-family: monospace; color: #444;">${coordInicial}</span>
//                     </div>
//                     <div>
//                         <strong style="color: #00796B;"><i class="fa-solid fa-stop text-danger"></i> Final:</strong><br>
...
//                     <div style="background-color: #E0F7FA; padding: 6px; text-align: center; border: 1px solid #B2EBF2; border-radius: 4px;">
//                         <strong style="color: #006064; font-size: 11px; display: block;">Avance Físico</strong>
//                         <span style="font-weight: 800; font-size: 15px; color: #006064;">${avanceFis}%</span>
//                     </div>
//                     <div style="background-color: #F1F8E9; padding: 6px; text-align: center; border: 1px solid #DCEDC8; border-radius: 4px;">
//                         <strong style="color: #33691E; font-size: 11px; display: block;">Avance Finan.</strong>
//                         <span style="font-weight: 800; font-size: 15px; color: #33691E;">${avanceFin}%</span>
//                     </div>
//                 </div>

//                 <div style="background: #E0F2F1; text-align: right; padding: 10px; font-weight: bold; color: #00695C; border-radius: 4px; font-size: 14px;">
//                     Monto: ${montoFormat}
//                 </div>
//             </div>
//         </div>
