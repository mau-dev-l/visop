...
export function initSearchControls(map) {
    const SearchControl = L.Control.extend({
        ...
        onAdd: function() {
            ...
            // Evitar que la interacción con los controles se propague al mapa
            L.DomEvent.disableClickPropagation(container);
            
            container.innerHTML = `
                <div class="search-container-map shadow">
                    <div class="d-flex gap-2 mb-2">
                        <button id="btn-map-home" class="btn btn-sm btn-custom-tuxtla flex-fill" title="Restablecer Vista">
                            <i class="fa-solid fa-house-chimney"></i> Inicio
                        </button>
                        <button id="btn-map-gps" class="btn btn-sm btn-primary flex-fill" title="Mi Ubicación">
                            <i class="fa-solid fa-location-crosshairs"></i> GPS
                        </button>
                        <button id="btn-map-manual" class="btn btn-sm btn-dark flex-fill" title="Manual de Usuario" data-bs-toggle="modal" data-bs-target="#modalManual">
                            <i class="fa-solid fa-question"></i> Ayuda
                        </button>
                    </div>

                    <button id="btn-map-clean-gps" class="btn btn-sm btn-danger w-100 mb-2 shadow-sm" style="display: none;" title="Limpiar rastro">
                        <i class="fa-solid fa-trash-can"></i> Limpiar rastro GPS
                    </button>
                    ...
                    <div class="map-search-item">
                        <div class="input-group input-group-sm">
                            ...
                            <button id="btn-clear-colonia" class="btn btn-white border-start-0" type="button">
                    ...
                    <div class="map-search-item mt-2">
                        <div class="input-group input-group-sm">
                            ...
                            <button id="btn-search-coords" class="btn btn-custom-tuxtla" type="button">
                                <i class="fa-solid fa-location-arrow"></i>
                            </button>
                            <button id="btn-clear-coords" class="btn btn-white border-start-0" type="button">
